        ...
        <div className="xl:pt-50 md:pt-40 pt-37.5 md:pl-17.5 max-md:px-5 max-w-255">
          ...
          <div className="relative">
            <motion.h1
              ...
              className="!font-display 2xl:!text-62xl xl:!text-45xl md:!text-32xl !text-80 !text-white relative inline-block animate-slide-left"
              title="Morocco"
            >
              Morocco
            </motion.h1>
            <h1
              className="!font-display 2xl:!text-62xl xl:!text-45xl md:!text-32xl !text-80 !text-transparent absolute left-0 top-0 z-1 [-webkit-text-stroke:2px_#fff] animate-slide-left pointer-events-none"
              title="Morocco"
            >
              Morocco
            </h1>
